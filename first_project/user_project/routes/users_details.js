...
router.patch('/update-user-status/:id', auth_validation.authenticate_token, user_details_middlewaer.id_params_check,user_details_middlewaer.role_check, user_details_middlewaer.update_user, users_detail.update);
