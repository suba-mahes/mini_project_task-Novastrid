...
describe('login as admin and whole working process', function() {
    ...
    it("get-allusers page - (401-error)", function(done){
        request(app)
    ...
    //updating - 404
    it('should update a user (404-error) on PUT ', function(done) {
        const req_data = {
            "first_name": "suba mahes",
            "last_name": "inba",
            "gender": "male",
    ...
    //updating the user's active status (404-error)
    it('should update the active status of an user (404-error) on PATCH method ', function(done) {
        const req_data = {
            "is_active": false
        }
        request(app)
